...
if (isset($array['assets_insured']) && $array['assets_insured'] !== null) $array['assets_insured'] = (int)$array['assets_insured'];

$DBLIB->where("assets_id", $array['assets_id']);
$DBLIB->where("assets.instances_id",$AUTH->data['instance']["instances_id"]);
$DBLIB->join("assetTypes","assets.assetTypes_id=assetTypes.assetTypes_id","LEFT");
$asset = $DBLIB->getone("assets", ['assets.assets_dayRate','assets.assets_tag','assets.assets_weekRate','assets.assets_mass','assets.assets_value','assets.assets_insured','assetTypes.assetTypes_mass','assetTypes.assetTypes_value',"assetTypes.assetTypes_dayRate","assetTypes.assetTypes_weekRate","assetTypes.assetTypes_insured"]);
...
$effectiveInsured = (isset($array['assets_insured']) && $array['assets_insured'] !== null) ? $array['assets_insured'] : ($asset['assetTypes_insured'] ?? 0);
$effectiveValue = ($array['assets_value'] !== null) ? $array['assets_value'] : ($asset['assetTypes_value'] ?? 0);
if ($effectiveInsured == 1 && ($effectiveValue === null || $effectiveValue == 0)) finish(false, ["code" => "VALIDATION-ERROR", "message" => "A value must be set before marking an asset as insured"]);
